...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('uk', 'ru');
  CREATE TYPE "public"."enum_users_roles" AS ENUM('owner', 'admin', 'manager', 'contentEditor', 'customer');
  ...
  CREATE TYPE "public"."enum_pages_blocks_hero_variant" AS ENUM('split', 'centered', 'background');
  CREATE TYPE "public"."enum_pages_blocks_hero_text_theme" AS ENUM('dark', 'light');
  CREATE TYPE "public"."enum_pages_blocks_hero_vertical_padding" AS ENUM('compact', 'large', 'screen');
  CREATE TYPE "public"."enum_pages_blocks_hero_background_type" AS ENUM('color', 'media', 'none');
  CREATE TYPE "public"."enum_pages_blocks_hero_overlay" AS ENUM('none', 'soft', 'strong');
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_cta_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_cta_appearance" AS ENUM('legacy', 'premiumBand');
  CREATE TYPE "public"."enum_pages_blocks_category_highlights_appearance" AS ENUM('premiumTiles', 'compactGrid');
  CREATE TYPE "public"."enum_pages_blocks_category_highlights_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_featured_products_appearance" AS ENUM('premiumGrid', 'spotlight');
  CREATE TYPE "public"."enum_pages_blocks_featured_products_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_testimonials_appearance" AS ENUM('premiumCards');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_content_columns_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_content_appearance" AS ENUM('plain', 'cards', 'steps', 'spotlightSteps', 'quotes');
  CREATE TYPE "public"."enum_pages_blocks_archive_appearance" AS ENUM('grid', 'premiumGrid');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_hero_variant" AS ENUM('split', 'centered', 'background');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_text_theme" AS ENUM('dark', 'light');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_vertical_padding" AS ENUM('compact', 'large', 'screen');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_background_type" AS ENUM('color', 'media', 'none');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_overlay" AS ENUM('none', 'soft', 'strong');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_cta_appearance" AS ENUM('legacy', 'premiumBand');
  CREATE TYPE "public"."enum__pages_v_blocks_category_highlights_appearance" AS ENUM('premiumTiles', 'compactGrid');
  CREATE TYPE "public"."enum__pages_v_blocks_category_highlights_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_featured_products_appearance" AS ENUM('premiumGrid', 'spotlight');
  CREATE TYPE "public"."enum__pages_v_blocks_featured_products_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_testimonials_appearance" AS ENUM('premiumCards');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_size" AS ENUM('oneThird', 'half', 'twoThirds', 'full');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_content_columns_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_content_appearance" AS ENUM('plain', 'cards', 'steps', 'spotlightSteps', 'quotes');
  CREATE TYPE "public"."enum__pages_v_blocks_archive_appearance" AS ENUM('grid', 'premiumGrid');
  ...
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('uk', 'ru');
  CREATE TYPE "public"."enum_product_types_attributes_input_type" AS ENUM('select', 'text', 'number', 'boolean');
  ...
  CREATE TYPE "public"."enum_variants_currency" AS ENUM('UAH');
  CREATE TYPE "public"."enum_variants_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__variants_v_version_currency" AS ENUM('UAH');
  CREATE TYPE "public"."enum__variants_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__variants_v_published_locale" AS ENUM('uk', 'ru');
  ...
  CREATE TYPE "public"."enum_products_blocks_cta_appearance" AS ENUM('legacy', 'premiumBand');
  ...
  CREATE TYPE "public"."enum_products_blocks_content_appearance" AS ENUM('plain', 'cards', 'steps', 'spotlightSteps', 'quotes');
  CREATE TYPE "public"."enum_products_currency" AS ENUM('UAH');
  ...
  CREATE TYPE "public"."enum__products_v_blocks_cta_appearance" AS ENUM('legacy', 'premiumBand');
  ...
  CREATE TYPE "public"."enum__products_v_blocks_content_appearance" AS ENUM('plain', 'cards', 'steps', 'spotlightSteps', 'quotes');
  CREATE TYPE "public"."enum__products_v_version_currency" AS ENUM('UAH');
  CREATE TYPE "public"."enum__products_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__products_v_published_locale" AS ENUM('uk', 'ru');
  CREATE TYPE "public"."enum_carts_currency" AS ENUM('UAH');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('new', 'paid', 'processing', 'shipped', 'completed', 'cancelled', 'refunded');
  CREATE TYPE "public"."enum_orders_currency" AS ENUM('UAH');
  CREATE TYPE "public"."enum_orders_payment_status" AS ENUM('unpaid', 'paid', 'refunded', 'cancelled');
  CREATE TYPE "public"."enum_orders_fulfillment_status" AS ENUM('new', 'processing', 'shipped', 'completed', 'cancelled');
  CREATE TYPE "public"."enum_orders_delivery_method" AS ENUM('pickup', 'nova_poshta', 'ukrposhta', 'other');
  CREATE TYPE "public"."enum_orders_delivery_details_provider" AS ENUM('pickup', 'nova_poshta', 'ukrposhta');
  CREATE TYPE "public"."enum_orders_stock_reservation_status" AS ENUM('none', 'reserved', 'released');
  ...
  CREATE TABLE "pages_blocks_hero" (
  	...
  	"text_theme" "enum_pages_blocks_hero_text_theme" DEFAULT 'dark',
  	"vertical_padding" "enum_pages_blocks_hero_vertical_padding" DEFAULT 'large',
  	"background_type" "enum_pages_blocks_hero_background_type" DEFAULT 'color',
  	"background_color" varchar DEFAULT '#f6f3ef',
  	"dark_background_color" varchar,
  	"background_media_id" integer,
  	"dark_background_media_id" integer,
  	"overlay" "enum_pages_blocks_hero_overlay" DEFAULT 'none',
  	"media_id" integer,
  	"dark_theme_media_id" integer,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_pages_blocks_cta_appearance" DEFAULT 'premiumBand',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_category_highlights" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_pages_blocks_category_highlights_appearance" DEFAULT 'premiumTiles',
  	"populate_by" "enum_pages_blocks_category_highlights_populate_by" DEFAULT 'selection',
  	"limit" numeric DEFAULT 6,
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_category_highlights_locales" (
  	"intro_content" jsonb,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "pages_blocks_featured_products" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_pages_blocks_featured_products_appearance" DEFAULT 'premiumGrid',
  	"populate_by" "enum_pages_blocks_featured_products_populate_by" DEFAULT 'collection',
  ...
  CREATE TABLE "pages_blocks_testimonials" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_pages_blocks_testimonials_appearance" DEFAULT 'premiumCards',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_pages_blocks_content_appearance" DEFAULT 'plain',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_archive" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_pages_blocks_archive_appearance" DEFAULT 'grid',
  ...
  CREATE TABLE "_pages_v_blocks_hero" (
  	...
  	"text_theme" "enum__pages_v_blocks_hero_text_theme" DEFAULT 'dark',
  	"vertical_padding" "enum__pages_v_blocks_hero_vertical_padding" DEFAULT 'large',
  ...
  CREATE TABLE "_pages_v_blocks_cta" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__pages_v_blocks_cta_appearance" DEFAULT 'premiumBand',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_category_highlights" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__pages_v_blocks_category_highlights_appearance" DEFAULT 'premiumTiles',
  	"populate_by" "enum__pages_v_blocks_category_highlights_populate_by" DEFAULT 'selection',
  	"limit" numeric DEFAULT 6,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_category_highlights_locales" (
  	"intro_content" jsonb,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_pages_v_blocks_featured_products" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__pages_v_blocks_featured_products_appearance" DEFAULT 'premiumGrid',
  	"populate_by" "enum__pages_v_blocks_featured_products_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 4,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_testimonials" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__pages_v_blocks_testimonials_appearance" DEFAULT 'premiumCards',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_content" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__pages_v_blocks_content_appearance" DEFAULT 'plain',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_archive" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__pages_v_blocks_archive_appearance" DEFAULT 'grid',
  ...
  CREATE TABLE "product_types_variant_axes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"variant_type_id" integer NOT NULL,
  	"affects_media" boolean DEFAULT false,
  	"affects_inventory" boolean DEFAULT true,
  	"show_in_filters" boolean DEFAULT true
  );
  
  CREATE TABLE "product_types_attributes_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"value" varchar
  ...
  CREATE TABLE "product_types_attributes_options_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "product_types_attributes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  	"input_type" "enum_product_types_attributes_input_type" DEFAULT 'select' NOT NULL,
  	"show_in_filters" boolean DEFAULT true
  );
  
  CREATE TABLE "product_types_attributes_locales" (
  ...
  CREATE TABLE "variants" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"price" numeric,
  	"currency" "enum_variants_currency" DEFAULT 'UAH',
  	"compare_at_price" numeric,
  	"price_in_u_a_h_enabled" boolean DEFAULT true,
  	"price_in_u_a_h" numeric,
  	"product_id" integer,
  ...
  CREATE TABLE "_variants_v" (
  	...
  	"version_currency" "enum__variants_v_version_currency" DEFAULT 'UAH',
  	"version_compare_at_price" numeric,
  	"version_price_in_u_a_h_enabled" boolean DEFAULT true,
  	"version_price_in_u_a_h" numeric,
  ...
  CREATE TABLE "_variants_v_locales" (
  	"version_title" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "products_blocks_cta" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_products_blocks_cta_appearance" DEFAULT 'premiumBand',
  	"rich_text" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "products_blocks_content" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"appearance" "enum_products_blocks_content_appearance" DEFAULT 'plain',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "products_attribute_values_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "products_reviews_locales" (
  	"text" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "products" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"price" numeric,
  	"currency" "enum_products_currency" DEFAULT 'UAH',
  	"compare_at_price" numeric,
  	"price_in_u_a_h_enabled" boolean DEFAULT true,
  	"price_in_u_a_h" numeric,
  	"inventory" numeric DEFAULT 0,
  	"enable_variants" boolean,
  	"review_summary_rating" numeric,
  	"review_summary_review_count" numeric,
  	"product_type_id" integer,
  	"media_variant_type_id" integer,
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_products_v_blocks_cta" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__products_v_blocks_cta_appearance" DEFAULT 'premiumBand',
  	"rich_text" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_products_v_blocks_content" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"appearance" "enum__products_v_blocks_content_appearance" DEFAULT 'plain',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_products_v_version_attribute_values" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "_products_v_version_attribute_values_locales" (
  	"label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_products_v_version_reviews_locales" (
  	"text" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_products_v" (
  	...
  	"parent_id" integer,
  	"version_price" numeric,
  	"version_currency" "enum__products_v_version_currency" DEFAULT 'UAH',
  	"version_compare_at_price" numeric,
  	"version_price_in_u_a_h_enabled" boolean DEFAULT true,
  	"version_price_in_u_a_h" numeric,
  	"version_inventory" numeric DEFAULT 0,
  	"version_enable_variants" boolean,
  	"version_review_summary_rating" numeric,
  	"version_review_summary_review_count" numeric,
  	"version_product_type_id" integer,
  	"version_media_variant_type_id" integer,
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "orders" (
  	...
  	"delivery_details_provider" "enum_orders_delivery_details_provider",
  	"delivery_details_city_i_d" varchar,
  	"delivery_details_city_label" varchar,
  	"delivery_details_warehouse_i_d" varchar,
  	"delivery_details_warehouse_label" varchar,
  	"delivery_details_recipient_name" varchar,
  	"delivery_details_recipient_phone" varchar,
  	"delivery_details_price" numeric,
  	"delivery_details_free_shipping" boolean DEFAULT false,
  	"delivery_details_tracking_number" varchar,
  	"delivery_details_notes" varchar,
  	"tracking_number" varchar,
  	"stock_reservation_status" "enum_orders_stock_reservation_status" DEFAULT 'none',
  ...
  CREATE TABLE "header_nav_items" (
  	...
  	"enable_mega_menu" boolean DEFAULT false,
  ...
  CREATE TABLE "admin_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"open_live_preview_on_load" boolean DEFAULT false,
  	"delivery_nova_poshta_enabled" boolean DEFAULT true,
  	"delivery_ukrposhta_enabled" boolean DEFAULT true,
  	"delivery_pickup_enabled" boolean DEFAULT true,
  	"delivery_pickup_instructions" varchar,
  	"delivery_free_shipping_from" numeric,
  	"delivery_fixed_shipping_price" numeric,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "pages_blocks_hero" ADD CONSTRAINT "pages_blocks_hero_dark_background_media_id_media_id_fk" FOREIGN KEY ("dark_background_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_hero" ADD CONSTRAINT "pages_blocks_hero_dark_theme_media_id_media_id_fk" FOREIGN KEY ("dark_theme_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_category_highlights" ADD CONSTRAINT "pages_blocks_category_highlights_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_category_highlights_locales" ADD CONSTRAINT "pages_blocks_category_highlights_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_category_highlights"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_hero" ADD CONSTRAINT "_pages_v_blocks_hero_dark_background_media_id_media_id_fk" FOREIGN KEY ("dark_background_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_hero" ADD CONSTRAINT "_pages_v_blocks_hero_dark_theme_media_id_media_id_fk" FOREIGN KEY ("dark_theme_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_category_highlights" ADD CONSTRAINT "_pages_v_blocks_category_highlights_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_category_highlights_locales" ADD CONSTRAINT "_pages_v_blocks_category_highlights_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_category_highlights"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "categories" ADD CONSTRAINT "categories_product_type_id_product_types_id_fk" FOREIGN KEY ("product_type_id") REFERENCES "public"."product_types"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "product_types_variant_axes" ADD CONSTRAINT "product_types_variant_axes_variant_type_id_variant_types_id_fk" FOREIGN KEY ("variant_type_id") REFERENCES "public"."variant_types"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "product_types_variant_axes" ADD CONSTRAINT "product_types_variant_axes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."product_types"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "product_types_attributes_options" ADD CONSTRAINT "product_types_attributes_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."product_types_attributes"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "product_types_attributes_options_locales" ADD CONSTRAINT "product_types_attributes_options_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."product_types_attributes_options"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "product_types_attributes" ADD CONSTRAINT "product_types_attributes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."product_types"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "product_types_attributes_locales" ADD CONSTRAINT "product_types_attributes_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."product_types_attributes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "variants_locales" ADD CONSTRAINT "variants_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."variants"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_variants_v_locales" ADD CONSTRAINT "_variants_v_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_variants_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "products_attribute_values" ADD CONSTRAINT "products_attribute_values_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "products_attribute_values_locales" ADD CONSTRAINT "products_attribute_values_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products_attribute_values"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "products_reviews_locales" ADD CONSTRAINT "products_reviews_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products_reviews"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "products" ADD CONSTRAINT "products_media_variant_type_id_variant_types_id_fk" FOREIGN KEY ("media_variant_type_id") REFERENCES "public"."variant_types"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_attribute_values" ADD CONSTRAINT "_products_v_version_attribute_values_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_products_v_version_attribute_values_locales" ADD CONSTRAINT "_products_v_version_attribute_values_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v_version_attribute_values"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_reviews_locales" ADD CONSTRAINT "_products_v_version_reviews_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v_version_reviews"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v" ADD CONSTRAINT "_products_v_version_media_variant_type_id_variant_types_id_fk" FOREIGN KEY ("version_media_variant_type_id") REFERENCES "public"."variant_types"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_hero_dark_background_media_idx" ON "pages_blocks_hero" USING btree ("dark_background_media_id");
  CREATE INDEX "pages_blocks_hero_media_idx" ON "pages_blocks_hero" USING btree ("media_id");
  CREATE INDEX "pages_blocks_hero_dark_theme_media_idx" ON "pages_blocks_hero" USING btree ("dark_theme_media_id");
  ...
  CREATE INDEX "pages_blocks_category_highlights_order_idx" ON "pages_blocks_category_highlights" USING btree ("_order");
  CREATE INDEX "pages_blocks_category_highlights_parent_id_idx" ON "pages_blocks_category_highlights" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_category_highlights_path_idx" ON "pages_blocks_category_highlights" USING btree ("_path");
  CREATE UNIQUE INDEX "pages_blocks_category_highlights_locales_locale_parent_id_un" ON "pages_blocks_category_highlights_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_hero_dark_background_media_idx" ON "_pages_v_blocks_hero" USING btree ("dark_background_media_id");
  CREATE INDEX "_pages_v_blocks_hero_media_idx" ON "_pages_v_blocks_hero" USING btree ("media_id");
  CREATE INDEX "_pages_v_blocks_hero_dark_theme_media_idx" ON "_pages_v_blocks_hero" USING btree ("dark_theme_media_id");
  ...
  CREATE INDEX "_pages_v_blocks_category_highlights_order_idx" ON "_pages_v_blocks_category_highlights" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_category_highlights_parent_id_idx" ON "_pages_v_blocks_category_highlights" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_category_highlights_path_idx" ON "_pages_v_blocks_category_highlights" USING btree ("_path");
  CREATE UNIQUE INDEX "_pages_v_blocks_category_highlights_locales_locale_parent_id" ON "_pages_v_blocks_category_highlights_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "categories_product_type_idx" ON "categories" USING btree ("product_type_id");
  ...
  CREATE INDEX "product_types_variant_axes_order_idx" ON "product_types_variant_axes" USING btree ("_order");
  CREATE INDEX "product_types_variant_axes_parent_id_idx" ON "product_types_variant_axes" USING btree ("_parent_id");
  CREATE INDEX "product_types_variant_axes_variant_type_idx" ON "product_types_variant_axes" USING btree ("variant_type_id");
  CREATE INDEX "product_types_attributes_options_order_idx" ON "product_types_attributes_options" USING btree ("_order");
  CREATE INDEX "product_types_attributes_options_parent_id_idx" ON "product_types_attributes_options" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "product_types_attributes_options_locales_locale_parent_id_un" ON "product_types_attributes_options_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "product_types_attributes_order_idx" ON "product_types_attributes" USING btree ("_order");
  CREATE INDEX "product_types_attributes_parent_id_idx" ON "product_types_attributes" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "product_types_attributes_locales_locale_parent_id_unique" ON "product_types_attributes_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "variants_locales_locale_parent_id_unique" ON "variants_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_variants_v_locales_locale_parent_id_unique" ON "_variants_v_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "products_blocks_cta_links_locale_idx" ON "products_blocks_cta_links" USING btree ("_locale");
  ...
  CREATE INDEX "products_blocks_cta_locale_idx" ON "products_blocks_cta" USING btree ("_locale");
  ...
  CREATE INDEX "products_blocks_content_columns_locale_idx" ON "products_blocks_content_columns" USING btree ("_locale");
  ...
  CREATE INDEX "products_blocks_content_locale_idx" ON "products_blocks_content" USING btree ("_locale");
  ...
  CREATE INDEX "products_blocks_media_block_locale_idx" ON "products_blocks_media_block" USING btree ("_locale");
  CREATE INDEX "products_blocks_media_block_media_idx" ON "products_blocks_media_block" USING btree ("media_id");
  CREATE INDEX "products_attribute_values_order_idx" ON "products_attribute_values" USING btree ("_order");
  CREATE INDEX "products_attribute_values_parent_id_idx" ON "products_attribute_values" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "products_attribute_values_locales_locale_parent_id_unique" ON "products_attribute_values_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "products_reviews_locales_locale_parent_id_unique" ON "products_reviews_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "products_product_type_idx" ON "products" USING btree ("product_type_id");
  CREATE INDEX "products_media_variant_type_idx" ON "products" USING btree ("media_variant_type_id");
  ...
  CREATE INDEX "products_rels_pages_id_idx" ON "products_rels" USING btree ("pages_id","locale");
  CREATE INDEX "products_rels_variant_types_id_idx" ON "products_rels" USING btree ("variant_types_id","locale");
  CREATE INDEX "products_rels_variant_options_id_idx" ON "products_rels" USING btree ("variant_options_id","locale");
  ...
  CREATE INDEX "_products_v_blocks_cta_links_locale_idx" ON "_products_v_blocks_cta_links" USING btree ("_locale");
  ...
  CREATE INDEX "_products_v_blocks_cta_locale_idx" ON "_products_v_blocks_cta" USING btree ("_locale");
  ...
  CREATE INDEX "_products_v_blocks_content_columns_locale_idx" ON "_products_v_blocks_content_columns" USING btree ("_locale");
  ...
  CREATE INDEX "_products_v_blocks_content_locale_idx" ON "_products_v_blocks_content" USING btree ("_locale");
  ...
  CREATE INDEX "_products_v_blocks_media_block_locale_idx" ON "_products_v_blocks_media_block" USING btree ("_locale");
  CREATE INDEX "_products_v_blocks_media_block_media_idx" ON "_products_v_blocks_media_block" USING btree ("media_id");
  CREATE INDEX "_products_v_version_attribute_values_order_idx" ON "_products_v_version_attribute_values" USING btree ("_order");
  CREATE INDEX "_products_v_version_attribute_values_parent_id_idx" ON "_products_v_version_attribute_values" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "_products_v_version_attribute_values_locales_locale_parent_i" ON "_products_v_version_attribute_values_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_products_v_version_reviews_locales_locale_parent_id_unique" ON "_products_v_version_reviews_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "_products_v_version_version_media_variant_type_idx" ON "_products_v" USING btree ("version_media_variant_type_id");
  ...
  CREATE INDEX "_products_v_rels_pages_id_idx" ON "_products_v_rels" USING btree ("pages_id","locale");
  CREATE INDEX "_products_v_rels_variant_types_id_idx" ON "_products_v_rels" USING btree ("variant_types_id","locale");
  CREATE INDEX "_products_v_rels_variant_options_id_idx" ON "_products_v_rels" USING btree ("variant_options_id","locale");
  ...
  CREATE INDEX "header_rels_categories_id_idx" ON "header_rels" USING btree ("categories_id","locale");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_category_highlights" CASCADE;
  DROP TABLE "pages_blocks_category_highlights_locales" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_category_highlights" CASCADE;
  DROP TABLE "_pages_v_blocks_category_highlights_locales" CASCADE;
  ...
  DROP TABLE "product_types_variant_axes" CASCADE;
  DROP TABLE "product_types_attributes_options" CASCADE;
  DROP TABLE "product_types_attributes_options_locales" CASCADE;
  DROP TABLE "product_types_attributes" CASCADE;
  DROP TABLE "product_types_attributes_locales" CASCADE;
  ...
  DROP TABLE "variants_locales" CASCADE;
  DROP TABLE "variants_rels" CASCADE;
  DROP TABLE "_variants_v" CASCADE;
  DROP TABLE "_variants_v_locales" CASCADE;
  ...
  DROP TABLE "products_attribute_values" CASCADE;
  DROP TABLE "products_attribute_values_locales" CASCADE;
  DROP TABLE "products_reviews" CASCADE;
  DROP TABLE "products_reviews_locales" CASCADE;
  ...
  DROP TABLE "_products_v_version_attribute_values" CASCADE;
  DROP TABLE "_products_v_version_attribute_values_locales" CASCADE;
  DROP TABLE "_products_v_version_reviews" CASCADE;
  DROP TABLE "_products_v_version_reviews_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_hero_text_theme";
  DROP TYPE "public"."enum_pages_blocks_hero_vertical_padding";
  ...
  DROP TYPE "public"."enum_pages_blocks_cta_appearance";
  DROP TYPE "public"."enum_pages_blocks_category_highlights_appearance";
  DROP TYPE "public"."enum_pages_blocks_category_highlights_populate_by";
  DROP TYPE "public"."enum_pages_blocks_featured_products_appearance";
  DROP TYPE "public"."enum_pages_blocks_featured_products_populate_by";
  DROP TYPE "public"."enum_pages_blocks_testimonials_appearance";
  DROP TYPE "public"."enum_pages_blocks_content_columns_size";
  DROP TYPE "public"."enum_pages_blocks_content_columns_link_type";
  DROP TYPE "public"."enum_pages_blocks_content_columns_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_content_appearance";
  DROP TYPE "public"."enum_pages_blocks_archive_appearance";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_hero_text_theme";
  DROP TYPE "public"."enum__pages_v_blocks_hero_vertical_padding";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_cta_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_category_highlights_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_category_highlights_populate_by";
  DROP TYPE "public"."enum__pages_v_blocks_featured_products_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_featured_products_populate_by";
  DROP TYPE "public"."enum__pages_v_blocks_testimonials_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_content_columns_size";
  DROP TYPE "public"."enum__pages_v_blocks_content_columns_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_content_columns_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_content_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_archive_appearance";
  ...
  DROP TYPE "public"."enum_product_types_attributes_input_type";
  DROP TYPE "public"."enum_forms_confirmation_type";
  DROP TYPE "public"."enum_addresses_country";
  DROP TYPE "public"."enum_variants_currency";
  DROP TYPE "public"."enum_variants_status";
  DROP TYPE "public"."enum__variants_v_version_currency";
  ...
  DROP TYPE "public"."enum_products_blocks_cta_appearance";
  ...
  DROP TYPE "public"."enum_products_blocks_content_appearance";
  ...
  DROP TYPE "public"."enum__products_v_blocks_cta_appearance";
  ...
  DROP TYPE "public"."enum__products_v_blocks_content_appearance";
  ...
  DROP TYPE "public"."enum_orders_delivery_details_provider";
  DROP TYPE "public"."enum_orders_stock_reservation_status";
